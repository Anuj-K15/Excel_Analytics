...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 p-4 h-96">
          ...
          <div className="p-8">
            ...
            <div className="mt-8 text-center animate-fade-in-up animation-delay-600">
              <p className="text-sm text-white/80">
                ...
                <a href="#" className="font-medium text-purple-300 hover:text-white transition-colors duration-300">
                  Sign up
                </a>
              </p>
            </div>
